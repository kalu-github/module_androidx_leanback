...
//
//public class RoundHelpLayout extends FrameLayout {
//
//    RoundHelper mRCHelper;
//
//    public RoundHelpLayout(Context context) {
//        super(context);
//    }
//
//    public RoundHelpLayout(Context context, AttributeSet attrs) {
//        super(context, attrs);
//        init(context, attrs);
//    }
//
//    public RoundHelpLayout(Context context, AttributeSet attrs, int defStyleAttr) {
//        super(context, attrs, defStyleAttr);
//        init(context, attrs);
//    }
//
//    @SuppressLint("NewApi")
//    public RoundHelpLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
