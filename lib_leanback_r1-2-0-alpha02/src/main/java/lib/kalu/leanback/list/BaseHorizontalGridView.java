...
class BaseHorizontalGridView extends androidx.leanback.widget.HorizontalGridView {
    ...
    public final ViewHolder findViewHolderAtFirst(@NonNull Class<?> cls) {
        try {
            ...
            LeanBackUtil.log("BaseHorizontalGridView => findViewHolderAtFirst => " + e.getMessage());
            return null;
        }
    }
    ...
    public final List<ViewHolder> findViewHolders(@NonNull Class<?> cls) {
        try {
            ...
            LeanBackUtil.log("BaseHorizontalGridView => findViewHolders => " + e.getMessage());
            return null;
        }
    }
    ...
    public final <T extends Presenter> T findPresenterFirst(Class<T> cls) {
        try {
            ...
            LeanBackUtil.log("BaseHorizontalGridView => findPresenterFirst => " + e.getMessage());
            return null;
        }
    }
    ...
    public final ViewHolder findViewHolderForAdapterObjectFirst(@NonNull Class<?> cls) {
        try {
            ...
            LeanBackUtil.log("BaseHorizontalGridView => findViewHolderForAdapterObjectFirst => " + e.getMessage());
            return null;
        }
    }
    ...
    public final List<ViewHolder> findViewHolderForAdapterObjectAll(@NonNull Class<?> cls) {
        try {
            ...
            LeanBackUtil.log("BaseHorizontalGridView => findViewHolderForAdapterObjectAll => " + e.getMessage());
            return null;
        }
    }
}
